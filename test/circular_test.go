...
func TestCircularInt(t *testing.T) {
	queue := znlib.NewCircularQueue[int](znlib.CircularFilo, 1, false)
	queue.Push()                   //nil
...
func TestCircularString(t *testing.T) {
	queue := znlib.NewCircularQueue[string](znlib.CircularFifoMaxsize, 10, false)
...
func TestCircularWalk(t *testing.T) {
	queue := znlib.NewCircularQueue[string](znlib.CircularFilo, 0, false, 3)
	queue.Push("Hello", "World", "U", "Are", "Welcome") //value list
